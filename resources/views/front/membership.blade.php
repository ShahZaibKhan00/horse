...
<section class="membership_new_sec">
   <div class="container">
      <div class="top_text_box text-center">
         <h2>SHOW POINTS</h2>
         <h3>SIMPLE, FLEXIBLE, BUILT FOR YOU.</h3>
         <p>Show Points are your all-access pass to listing on Horse Action Network. Each Show Point gives you one active ad for 30 days—whether it's a horse, service, or property. 
            Buy a monthly package, and your Show Points are added to your wallet automatically. Use them as you need, and any unused points roll over for up to 6 months. 
            When your package renews each month, you get fresh Show Points to keep your ads running.
         </p>
      </div>
                     ...
                     <div class="row">
                        <div class="col-lg-4">
                           <div class="step_inner_box">
                              <img src="assets/images/step_inner_img_1.png" class="img-fluid"/>
                              <h6>Horses</h6>
                           </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="step_inner_box">
                              <img src="assets/images/step_inner_img_2.png" class="img-fluid"/>
                              <h6>Services</h6>
                           </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="step_inner_box">
                              <img src="assets/images/step_inner_img_3.png" class="img-fluid"/>
                              <h6>Real Estate</h6>
                           </div>
                        </div>
                     </div>
   ...
   <div class="inner-container-one">
      <div class="top_text_box text-center">
         <h2>LIST LIKE YOU MEAN IT</h2>
         <p>More details. More visibility. More results.</p>
      </div>
      <div class="colored_text_box">
