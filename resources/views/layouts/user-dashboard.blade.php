        ...
        <div class="inner_content_wrapper">
            <div class="welcome-container">
                <div class="welcome-content">
                    <img src="{{ getenv('APP_URL') }}/assets/front/images/welcome_img.png" alt="Horse" class="horse-image">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="count_boxs">
                                    <div class="icon_box">
                                        <img src="{{ getenv('APP_URL') }}/assets/front/images/count_icon_1.png" alt="" class="img-fluid">
                                    </div>
                                    <p>12</p>
                                    <p>Horse</p>
                                    <a href="#!">View All</a>
                            ...
                            <div class="col-md-4">
                                <div class="count_boxs">
                                    <div class="icon_box">
                                        <img src="{{ getenv('APP_URL') }}/assets/front/images/count_icon_2.png" alt="" class="img-fluid">
                                    </div>
                                    <p>5</p>
                                    <p>Services</p>
                                    <a href="#!">View All</a>
                            ...
                            <div class="col-md-4">
                                <div class="count_boxs">
                                    <div class="icon_box">
                                        <img src="{{ getenv('APP_URL') }}/assets/front/images/count_icon_3.png" alt="" class="img-fluid">
                                    </div>
                                    <p>3</p>
                                    <p>Real Estate</p>
                                    <a href="#!">View All</a>
                    ...
                    <div class="data_box">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="count_boxs">
                                    <div class="icon_box">
                                        <img src="{{ getenv('APP_URL') }}/assets/front/images/count_icon_4.png" alt="" class="img-fluid">
                                    </div>
                                    <p>12</p>
                                    <p>Horse</p>
                                    <a href="#!">View All</a>
                            ...
                            <div class="col-md-4">
                                <div class="count_boxs">
                                    <div class="icon_box">
                                        <img src="{{ getenv('APP_URL') }}/assets/front/images/count_icon_5.png" alt="" class="img-fluid">
                                    </div>
                                    <p>5</p>
                                    <p>Services</p>
                                    <a href="#!">View All</a>
                            ...
                            <div class="col-md-4">
                                <div class="count_boxs">
                                    <div class="icon_box">
                                        <img src="{{ getenv('APP_URL') }}/assets/front/images/count_icon_6.png" alt="" class="img-fluid">
                                    </div>
                                    <p>3</p>
                                    <p>Real Estate</p>
                                    <a href="#!">View All</a>
                ...
                <div class="dashboard-grid">
                    ...
                    <div class="dashboard-item">
                        <div class="icon-wrapper">
                            <img src="{{ getenv('APP_URL') }}/assets/front/images/info_icon_1.png" alt="" class="img-fluid">
                        </div>
                    ...
                    <div class="dashboard-item">
                        <div class="icon-wrapper">
                            <img src="{{ getenv('APP_URL') }}/assets/front/images/info_icon_2.png" alt="" class="img-fluid">
                        </div>
                    ...
                    <div class="dashboard-item">
                        <div class="icon-wrapper">
                            <img src="{{ getenv('APP_URL') }}/assets/front/images/info_icon_3.png" alt="" class="img-fluid">
                        </div>
                    ...
                    <div class="dashboard-item">
                        <div class="icon-wrapper">
                            <img src="{{ getenv('APP_URL') }}/assets/front/images/info_icon_4.png" alt="" class="img-fluid">
                        </div>
                    ...
                    <div class="dashboard-item next-billing">
                        <div class="icon-wrapper">
                            <img src="{{ getenv('APP_URL') }}/assets/front/images/info_icon_5.png" alt="" class="img-fluid">
                        </div>
            ...
            <div class="table_container">
                ...
                <div class="card horse-card">
                    <div class="card-header">
                        <div class="header-left">
                            <img src="{{ getenv('APP_URL') }}/assets/front/images/table_icon_1.png" alt="Horse" class="icon">
                ...
                <div class="card service-card">
                    <div class="card-header">
                        <div class="header-left">
                            <img src="{{ getenv('APP_URL') }}/assets/front/images/table_icon_2.png" alt="Service" class="icon">
                ...
                <div class="card realestate-card">
                    <div class="card-header">
                        <div class="header-left">
                            <img src="{{ getenv('APP_URL') }}/assets/front/images/table_icon_3.png" alt="Real Estate" class="icon">
