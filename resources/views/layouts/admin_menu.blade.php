...
<nav class="navbar navbar-vertical navbar-expand-lg" style="display:none;">
         ...
         <div class="nav-item-wrapper">
            <a class="nav-link dropdown-indicator label-1" href="#nv-product" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-CRM">
               <div class="d-flex align-items-center">
                  ...
                  <span class="nav-link-icon"><img class="" src="{{ getenv('APP_URL') }}/assets/images/admin_tab_icon_6.png" alt="" /></span><span class="nav-link-text">Listed Products</span><span class="fa-solid fa-circle text-info ms-1 new-page-indicator" style="font-size: 6px"></span>
               </div>
            </a>
   ...
   <div class="navbar-vertical-footer"><button class="btn navbar-vertical-toggle border-0 fw-semi-bold w-100 white-space-nowrap d-flex align-items-center"><span class="fs-0" data-feather="chevrons-right"></span><span class="navbar-vertical-footer-text ms-2">Collapsed View</span></button></div>
</nav>
