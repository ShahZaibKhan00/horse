...
<div class="content">
    ...
    <div class="row align-items-center mb-4">
        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
            <h2 class="mb-2 text-white main_heading_dashboard">Profile</h2>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
            <div class="action_btn_flex">
                <a href="{{url('edit_profile')}}" class="edit_gen_btn">Edit Profile</a>
                <div class="avatar-upload">
        ...
        <div class="col-12 col-xxl-12">
            <div class="row g-3">
                    ...
                    <div class="card h-100">
                        <div class="card-body p-3">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-6">
                                    <div class="box_frame">
                                        <h5 class="text-800 m-0">Business Name:</h5>

                                        <p class="text-800 m-0">{{$profile->bussiness_name ?? ""}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="box_frame">
                                        ...
                                        <a class="text-800" href="tel:+1{{$profile->Number}}">{{$profile->Number}}</a>
                                        @endif @if($profile->Number == "")
                                        <h5 class="text-800">Phone</h5>
                                        <a class="text-800" href="tel:+1 000 000 0000">(000) 000 0000</a>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="box_frame">
                                        <h5 class="text-800 m-0">Street Address:</h5>
                                        @if($profile->Address != "")
                                        <p class="text-800 m-0">{{$profile->Address}}</p>
                                ...
                                <div class="col-6">
                                    <div class="box_frame">
                                        <h5 class="text-800 m-0">Town:</h5>
                                        <p class="text-800 m-0">{{$profile->town ?? ""}}</p>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="box_frame">
                                        <h5 class="text-800 m-0">State:</h5>
                                        <p class="text-800 m-0">{{$profile->state ?? ""}}</p>
                                    </div>
                                </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body p-3">
                            ...
                            <div class="row g-2">
                                <div class="col-12">
                                    <div class="box_frame">
                                        <p class="text-800 m-0"><strong>Website Link:</strong> <a href="{{$profile->website_link  ?? "" }}" class="text-decoration-underline">{{$profile->website_link  ?? "" }}</a></p>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="box_frame">
                                        <p class="text-800 m-0"><strong>Facebook Link:</strong> <a href="{{$profile->facebook_link  ?? "" }}" class="text-decoration-underline">{{$profile->facebook_link  ?? "" }}</a></p>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="box_frame">
                                        <p class="text-800 m-0"><strong>Instagram Link:</strong> <a href="{{$profile->insta_link  ?? "" }}" class="text-decoration-underline">{{$profile->insta_link  ?? "" }}</a></p>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="box_frame">
                                        <p class="text-800 m-0"><strong>TikTok Link:</strong> <a href="{{$profile->tiktok_link  ?? "" }}" class="text-decoration-underline">{{$profile->tiktok_link  ?? "" }}</a></p>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="box_frame">
                                        <p class="text-800 m-0"><strong>Youtube Link:</strong> <a href="{{$profile->youtube_link  ?? "" }}" class="text-decoration-underline">{{$profile->youtube_link  ?? "" }}</a></p>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="box_frame">
                                        <p class="text-800 m-0"><strong>Google Business Link:</strong> <a href="{{$profile->business_link  ?? "" }}" class="text-decoration-underline">{{$profile->business_link  ?? "" }}</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-6 col-lg-6">
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            <h2 class="mb-3">Specialized Skills | Disciplines:</h2>
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            <h2 class="mb-3">Specialized Breeds:</h2>
                            <div class="dropdown-container">
                                <input type="hidden" name="pro_breeds" value="{{ is_array($profile->breed) ? implode(',', $profile->breed) : '' }}" />
                                <div class="dropdown-header" id="dropdownHeader2">
                                    <div class="tags" id="tagsContainer2"></div>
                                    @if (!empty($profile->breed))
                                        @foreach ($profile->breed as $item)
                                            <div class="tag">{{ $item }}</div>
                                        @endforeach
                                     @endif
                                    <!-- <input type="text" id="searchInput2" placeholder="Start typing" disabled oninput="handleInput(2)" onkeydown="handleKeyDown(event, 2)" />
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            ...
                            <div class="dropdown-container">
                                <input type="hidden" name="pro_services"  value="{{ is_array($profile->services) ? implode(',', $profile->services) : '' }}"/>
                                <div class="dropdown-header" id="dropdownHeader3">
                                    ...
                                    @if (!empty($profile->services))
                                        ...
                                        @endforeach
                                     @endif
                                    <!-- <input type="text" id="searchInput3" placeholder="Start typing" disabled oninput="handleInput(3)" onkeydown="handleKeyDown(event, 3)" />
                ...
                <div class="col-12 col-lg-12">
                  <div class="card mb-4">
                        <div class="card-body p-3">
                            ...
                            <textarea class="box_frame w-100 textarea_about" disabled>{{$profile->about ?? ""}}</textarea>
        ...
        (function () {
            const optionsById = {
                ...
                3: [
                    ...
                    "Carriage Hire",
                    "Children’s Camp",
                    "Chiropractor / Acupuncture / MagnaWave",
                    "Clubs",
                    "Construction",
                    "Cremation Service",
                    "Dentists",
                    ...
                    "Farriers",
                    "Feed Supply",
                    "Feed / Produce Supplier",
                    "Fencing Contractors / Suppliers",
                    "General Services",
                    "Giftware",
                    "Grooming / Clipping",
                    "Hay Delivery",
                    ...
                    "Tack Repair",
                    "Tack Stores",
                    "Therapeutic Riding Instructor / Coach",
                    "Trail Guide",
                    "Trail Riding",
                    "Trailers",
                    "Trainer / Rider",
                    ...
                    "Video Production",
                    "Riding Lessons (Beginner / Intermediate / Advanced)",
                    "Horse Training (Groundwork, Jumping, Dressage, etc.)",
                    "Boarding Services",
                    "Horse Grooming / Care",
                    "Equine Therapy / Healing",
                    "Horse Leasing",
                    "Trail Guiding",
                    "Mobile Equestrian Services",
            ...
            function filterOptions(query, id) {
                ...
                const filtered = allOptions.filter((option) => option.toLowerCase().startsWith(query.toLowerCase()) && !selectedValues[id].includes(option));
