        ...
        <div class="inner_content_wrapper">
            <div class="user_search_bar">
                ...
                <div class="custom_tabs">
                    ...
                    @else
                        <a href="javascript:;" class="custom_tab_btn custom_tab_btn_one" data-bs-toggle="modal" data-bs-target="#packageWarningModal">Create A NEW HORSE AD</a>
                    @endif
                    <a href="#!" class="custom_tab_btn_min active" data-tab="all">show</a>
                                    ...
                                    <div class="user_img_box">
                                        <div class="swiper user_card_slider swiper-wrapper">
                                            ...
                                            @empty
                                                ...
                                                <div class="swiper-slide">
                                                    <img src="https://html.kodesolution.com/2016/horeseman-html/demo/images/cou qrses/sm1.jpg" alt="" />
                                                </div>
                                                <div class="swiper-slide">
                                                    <img src="https://html.kodesolution.com/2016/horeseman-html/demo/images/blog/1.jpg" alt="" />
                                                </div>
