                        ...
                        <table class="table fs--1 mb-0 leads-table">
                            ...
                            <tbody class="list" id="leal-tables-body">
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="phone align-middle white-space-nowrap fw-semi-bold ps-4 border-end">
                                        @if ($addondata->Upload_Prescription)
                                            @php
                                                $images = json_decode($addondata->Upload_Prescription, true);
                                            @endphp
                                            @foreach ($images as $index => $image)
                                                <a href="{{ getenv('APP_URL') }}/cart_images/{{ $image }}" data-fancybox="gallery" data-caption="FancyBox Image {{ $index + 1 }}">
                                                    <img src="{{ getenv('APP_URL') }}/cart_images/{{ $image }}" alt="Thumbnail {{ $index + 1 }}" style="width: 100px; margin-right: 5px;">
                                                </a>
                                            @endforeach
                                        @endif
                                    </td>
