                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="d-flex gap-1 flex-column">
                                            ...
                                            <div class="form-check other_flooring_box">
                                                ...
                                                <input class="form-control gen_input_one" type="text" name="barn_flooring_other" value="{{ $is_other ? $barn_flooring : '' }}"
                                    ...
                                    <div class="col-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="checkbox" name="property_features[]" value="trails" {{ in_array('trails', $features) ? 'checked' : '' }}>
                                                        Trails
                                                    </label>
                                                </div>
                                                <div class="form-check">
