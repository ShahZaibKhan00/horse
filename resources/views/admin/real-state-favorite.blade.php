        ...
        <div class="pb-6">
            <div id="lealsTable" data-list='{"valueNames":["name","email","phone","contact","company","date"],"page":10,"pagination":true}'>
                <div class="row g-3 justify-content-between mb-4">
                    <div class="col-auto">
                        <h2 class="mb-2 text-white main_heading_dashboard">{{ count($realstates) }} Favorite Real-eStates</h2>
                    </div>
                    ...
                    @foreach ($realstates as $list)
                        <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                            <div class="horse_list_card">
                                        ...
                                        <div class="swiper-wrapper" id="swiper-wrapper-0d2fdcca6456cc58" aria-live="polite"
                                            ...
                                            @forelse ($images as $item)
                                                <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 4" data-swiper-slide-index="0" style="width: 583px;">
                                                    <img src="{{ asset('Gallery_imgs/' . $item) }}" alt="img" class="" />
                                                </div>
                                                {{-- </div> --}}
                                            @empty
                                                <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 4" data-swiper-slide-index="0" style="width: 583px;">
                                ...
                                <div class="blue_stripe">
                                    <h3>Price: {{ $list->realstate->real_price ?? '' }}</h3>
                                </div>
                                <div class="text_box">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="row">
                                                <div class="col-12">
                                                    <ul class="info_list">
                                                        <li><strong>Acres:</strong> {{ $list->realstate->real_acres ?? '' }}</li>
                                                        <li><strong>Bedrooms:</strong> {{ $list->realstate->real_bedroom ?? '' }} Old</li>
                                                        <li><strong>Bathroom:</strong> {{ $list->realstate->real_bathroom ?? '' }}</li>
                                                        <li><strong> Car Garage oversized:</strong> {{ $list->realstate->real_garage ?? '' }}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
