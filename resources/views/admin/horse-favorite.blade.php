        ...
        <div class="pb-6">
            <div id="lealsTable" data-list='{"valueNames":["name","email","phone","contact","company","date"],"page":10,"pagination":true}'>
                <div class="row g-3 justify-content-between mb-4">
                    <div class="col-auto">
                        <h2 class="mb-2 text-white main_heading_dashboard">{{ count($horses) }} Favorite Horses</h2>
                    </div>
                    ...
                    @foreach ($horses as $list)
                        <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                            <div class="horse_list_card">
                                ...
                                <div class="blue_stripe">
                                    <h3>Price: ${{ $list->product->pro_reg_price }}</h3>
                                </div>
                                <div class="text_box">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="row">
                                                <div class="col-12">
                                                    <ul class="info_list">
                                                        <li><strong>Breed:</strong> {{ $list->product->pro_breed }}</li>
                                                        <li><strong>Age:</strong> {{ $list->product->pro_age }} Old</li>
                                                        <li><strong>Sex:</strong> {{ $list->product->pro_gender }}</li>
                                                        <li><strong>Height:</strong> {{ $list->product->pro_height }}</li>
                                                        <li><strong>Ad Type:</strong> {{ $list->product->pro_ad_type }}</li>
                                                        <li><strong>Location:</strong> {{ $list->product->pro_state }}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
