...
<div id="preloader">
   <div class="white_box" id="w_box">
      ...
      <a href="{{ url('service-listing') }}" target="_blank">Back to Service Listing</a>
   </div>
</div>
...
<div class="pb-5">
   ...
   @endif
   <form method="POST" action="{{ url('/service_store') }}" enctype="multipart/form-data" class="row g-3 mb-6 justify-content-center" id="myForm">
      @csrf
      <div class="box_top">
      ...
      <div class="row gy-4">
               ...
               <div class="row">
                  ...
                  <div class="col-6">
                     ...
                     <div class="web_link_wrap">
                        <span>http://</span>
                        <input class="form-control gen_input_one mb-3 websiteInput" type="text" name="website_url" placeholder="Website URL (optional)" />
                     </div>
                  </div>
               </div>
            </div>
            <div class="border_box_one mb-3">
               ...
               <div class="row">
                      <div class="col-12">
                         ...
                         <input class="form-control gen_input mb-3" type="text" name="Address" placeholder="Enter Your Address" />
                      </div>
                      
                      <div class="col-4">
                          <h3 class="mb-2">Town / City<span class="asterisk">*</span></h3>
                         <input class="form-control gen_input mb-3" type="text" name="city" placeholder="Enter Town" />
                      </div>
                      <div class="col-4">
                     ...
                     <div class="col-4">
                        ...
                        <input class="form-control gen_input mb-3" type="text" name="zip_code" placeholder="Enter zip code" />
                     </div>
               </div>
            </div>
            <div class="col-12">
               ...
               <div class="border_box_one mb-3">
                  ...
                  <div class="col-12">
                     <div class="mb-3">
                        ...
                        <textarea class="textarea summernote" name="per_bio" style="width: 100%; height: 15rem;" placeholder="Tell your potential clients about you or your company"></textarea>
                     </div>
                  </div>
               </div>
               <div class="col-12">
               ...
               <div class="row custom_form_checks">
                  ...
                  <div class="col-md-4 ">
                     <div class="service-category">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="coggins_health_certs" id="coggins_health_certs">
                           <label class="form-check-label" for="coggins_health_certs">Coggins & health certificates</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="equine_dentistry" id="equine_dentistry">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="emergency_on_call_vet" id="emergency_on_call_vet">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="export_health_documentation" id="export_health_documentation">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="mobile_veterinary_services" id="mobile_veterinary_services">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="pre_purchase_exams" id="pre_purchase_exams">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="regenerative_medicine" id="regenerative_medicine">
                           <label class="form-check-label" for="regenerative_medicine">Regenerative medicine</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="rehabilitation_therapy" id="rehabilitation_therapy">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="reproductive_ultrasounds" id="reproductive_ultrasounds">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="sports_medicine" id="sports_medicine">
                     ...
                     <div class="service-category">
                            ...
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="pulling_manes" id="pulling_manes">
                               <label class="form-check-label" for="pulling_manes">Pulling manes</label>
                            </div>
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="quarter_mark_clipping" id="quarter_mark_clipping">
                               <label class="form-check-label" for="quarter_mark_clipping">Quarter mark clipping</label>
                            </div>
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="sales_prep_grooming" id="sales_prep_grooming">
                               <label class="form-check-label" for="sales_prep_grooming">Sales prep grooming</label>
                            </div>
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="sheath_cleaning" id="sheath_cleaning">
                               <label class="form-check-label" for="sheath_cleaning">Sheath cleaning</label>
                            </div>
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="show_grooming" id="show_grooming">
                            ...
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="turnout_preparation" id="turnout_preparation">
                  ...
                  <div class="col-md-4">
                     <div class="service-category">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="catch_riding" id="catch_riding">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="conditioning_rides" id="conditioning_rides">
                           <label class="form-check-label" for="conditioning_rides">Conditioning rides</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="confidence_building_horses" id="confidence_building_horses">
                           <label class="form-check-label" for="confidence_building_horses">Confidence building for horses</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="confidence_coaching_riders" id="confidence_coaching_riders">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="exercise_riding" id="exercise_riding">
                           <label class="form-check-label" for="exercise_riding">Exercise riding</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="finishing_programs" id="finishing_programs">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="horse_evaluation_services" id="horse_evaluation_services">
                           <label class="form-check-label" for="horse_evaluation_services">Horse evaluation services</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="horse_sales_consignment" id="horse_sales_consignment">
                           <label class="form-check-label" for="horse_sales_consignment">Horse Sale Consignment</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="general_horse_training" id="general_horse_training">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="ponying_services" id="ponying_services">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="problem_loading_trailer" id="problem_loading_trailer">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="sale_prep_training" id="sale_prep_training">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="trail_obstacle_training" id="trail_obstacle_training">
                           <label class="form-check-label" for="trail_obstacle_training">Trail obstacle training</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="tune_ups_refresher" id="tune_ups_refresher">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="young_horse_development" id="young_horse_development">
                     ...
                     <div class="service-category">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="broodmare_boarding" id="broodmare_boarding">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="foaling_stalls" id="foaling_stalls">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="medical_layup" id="medical_layup">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="quarantine_boarding" id="quarantine_boarding">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="sales_consignment_boarding" id="sales_consignment_boarding">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="stallion_boarding" id="stallion_boarding">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="training_board" id="training_board">
                     ...
                     <div class="service-category">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="barefoot_trimming" id="barefoot_trimming">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="corrective_trimming" id="corrective_trimming">
                           <label class="form-check-label" for="corrective_trimming">Corrective trimming</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="draft_horse_shoeing" id="draft_horse_shoeing">
                           <label class="form-check-label" for="draft_horse_shoeing">Draft horse shoeing</label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="gaited_horse_shoeing" id="gaited_horse_shoeing">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="hoof_boot_fitting" id="hoof_boot_fitting">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="laminitis_founder_care" id="laminitis_founder_care">
                     ...
                     <div class="service-category">
                        ...
                        <div class="form-check">
                           <input class="form-check-input" type="checkbox" name="services_offered[]" value="bit_fitting_services" id="bit_fitting_services">
                           <label class="form-check-label" for="bit_fitting_services">Bit fitting services</label>
                        </div>
                        <div class="form-check">
                  ...
                  <div class="col-md-4">
                      <div class="service-category">
                            ...
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="arena_dragging" id="arena_dragging">
                               <label class="form-check-label" for="arena_dragging">Arena dragging</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="arena_lighting_installation" id="arena_lighting_installation">
                               <label class="form-check-label" for="arena_lighting_installation">Arena lighting installation</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="barn_design_planning" id="barn_design_planning">
                               <label class="form-check-label" for="barn_design_planning">Barn Design & Planning</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="barn_kits_prefab_barns" id="barn_kits_prefab_barns">
                               <label class="form-check-label" for="barn_kits_prefab_barns">Barn Kits / Prefab Barns</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="barn_renovations_expansions" id="barn_renovations_expansions">
                               <label class="form-check-label" for="barn_renovations_expansions">Barn Renovations / Expansions</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="bush_hogging_field_mowing" id="bush_hogging_field_mowing">
                               <label class="form-check-label" for="bush_hogging_field_mowing">Bush hogging / field mowing</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="custom_barn_construction" id="custom_barn_construction">
                               <label class="form-check-label" for="custom_barn_construction">Custom Barn Construction</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="drainage_fixes" id="drainage_fixes">
                               <label class="form-check-label" for="drainage_fixes">Drainage Fixes</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="dust_control_systems" id="dust_control_systems">
                               <label class="form-check-label" for="dust_control_systems">Dust control systems</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="electrical_work" id="electrical_work">
                               <label class="form-check-label" for="electrical_work">Electrical Work</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="excavation_grading" id="excavation_grading">
                               <label class="form-check-label" for="excavation_grading">Excavation / grading</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="fence_repair_installation" id="fence_repair_installation">
                               <label class="form-check-label" for="fence_repair_installation">Fence Repair & Installation</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="footing_watering_systems" id="footing_watering_systems">
                               <label class="form-check-label" for="footing_watering_systems">Footing watering systems</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="general_property_maintenance" id="general_property_maintenance">
                               <label class="form-check-label" for="general_property_maintenance">General Property Maintenance</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="horse_fencing_consultation" id="horse_fencing_consultation">
                               <label class="form-check-label" for="horse_fencing_consultation">Horse fencing consultation</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="indoor_arenas" id="indoor_arenas">
                               <label class="form-check-label" for="indoor_arenas">Indoor Arenas</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="manure_removal" id="manure_removal">
                               <label class="form-check-label" for="manure_removal">Manure removal</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="minor_barn_renovations" id="minor_barn_renovations">
                               <label class="form-check-label" for="minor_barn_renovations">Minor Barn Renovations</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="outdoor_arenas" id="outdoor_arenas">
                               <label class="form-check-label" for="outdoor_arenas">Outdoor Arenas</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="paddock_design" id="paddock_design">
                               <label class="form-check-label" for="paddock_design">Paddock design</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="pole_barns_post_frame" id="pole_barns_post_frame">
                               <label class="form-check-label" for="pole_barns_post_frame">Pole Barns / Post Frame</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="run_in_sheds" id="run_in_sheds">
                               <label class="form-check-label" for="run_in_sheds">Run-in Sheds</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="stall_installation" id="stall_installation">
                               <label class="form-check-label" for="stall_installation">Stall Installation</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="stall_repairs" id="stall_repairs">
                               <label class="form-check-label" for="stall_repairs">Stall Repairs</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="tractor_services" id="tractor_services">
                               <label class="form-check-label" for="tractor_services">Tractor services</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="wash_stall_installation_repairs" id="wash_stall_installation_repairs">
                               <label class="form-check-label" for="wash_stall_installation_repairs">Wash Stall Installation / Repairs</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="water_systems" id="water_systems">
                        ...
                        <div class="service-category">
                            ...
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="bridle_fitting" id="bridle_fitting">
                               <label class="form-check-label" for="bridle_fitting">Bridle fitting</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="custom_saddles" id="custom_saddles">
                               <label class="form-check-label" for="custom_saddles">Custom saddles</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="horse_trailer_rentals" id="horse_trailer_rentals">
                               <label class="form-check-label" for="horse_trailer_rentals">Horse trailer rentals</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="saddle_cleaning_conditioning" id="saddle_cleaning_conditioning">
                               <label class="form-check-label" for="saddle_cleaning_conditioning">Saddle cleaning/conditioning</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="saddle_fitting" id="saddle_fitting">
                               <label class="form-check-label" for="saddle_fitting">Saddle fitting</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="saddle_flocking" id="saddle_flocking">
                               <label class="form-check-label" for="saddle_flocking">Saddle flocking</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="tack_consignment" id="tack_consignment">
                               <label class="form-check-label" for="tack_consignment">Tack consignment</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="tack_repair" id="tack_repair">
                               <label class="form-check-label" for="tack_repair">Tack repair</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="trailer_inspections" id="trailer_inspections">
                               <label class="form-check-label" for="trailer_inspections">Trailer inspections</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="trailer_repair" id="trailer_repair">
                               <label class="form-check-label" for="trailer_repair">Trailer repair</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="trailer_sales" id="trailer_sales">
                        ...
                        <div class="service-category">
                            ...
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="equine_real_estate_agent" id="equine_real_estate_agent">
                               <label class="form-check-label" for="equine_real_estate_agent">Equine real estate agent</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="facility_leasing" id="facility_leasing">
                               <label class="form-check-label" for="facility_leasing">Facility leasing</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="farm_appraisals" id="farm_appraisals">
                               <label class="form-check-label" for="farm_appraisals">Farm appraisals</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="farm_management_consulting" id="farm_management_consulting">
                               <label class="form-check-label" for="farm_management_consulting">Farm management consulting</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="investment_consulting" id="investment_consulting">
                               <label class="form-check-label" for="investment_consulting">Investment consulting</label>
                            </div>
                        
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" name="services_offered[]" value="property_staging_horse_farms" id="property_staging_horse_farms">
                         ...
                         <div class="service-category">
                            ...
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" value="" id="other_custom1">
                            ...
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" value="" id="other_custom2">
                            ...
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" value="" id="other_custom3">
                            ...
                            <div class="form-check">
                               <input class="form-check-input" type="checkbox" value="" id="other_custom4">
         ...
         <div class="col-12">
            <div class="border_box_one">
               ...
               <div class="">
                  <textarea class="textarea summernote" name="service_desc" style="width: 100%; height: 15rem;" placeholder="Write description here...." required></textarea>
               </div>
            </div>
         </div>
         <div class="col-12">
...
<div id="fsmOverlay" class="fsm-overlay">
   <div class="fsm-dialog">
      ...
      <div class="fsm-content">
         <div class="row mb-4">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
               <div class="seller_profile_img">
                  <img src="https://horse-dev.testlinkdev.com/service-profile/1768928008_84.png" alt="img" class="img-fluid">
               </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
               <div class="seller_profile_text_box text-center">
                  ...
                  <h1>Tyler Smith Farrier</h1>
                  <!-- <p>www.tylersmithfarrier.com</p> -->
                  <p>Cell: (862) 258-0279</p>
                  <p>doryzemeli@mailinator.com</p>
                  <p></p>
                  <div class="social_icons mt-4">
                     ...
                     <a href="" target="_blank" title="Website"><img src="/assets/images/website-icon-11.png" alt="img" class="img-fluid"></a>
                  </div>
               </div>
            </div>
         </div>
         <div class="profile_tabs__one mb-4">
            <!-- Experience Section -->
            <div class="experience-section">
               <div class="experience-item">
                  <div class="experience-label">EXPERIENCE</div>
                  <div class="experience-value">3 Years</div>
               </div>
               <div class="experience-item">
            ...
            <div class="about-section">
               ...
               <div class="certifications-section">
                  ...
                  <div class="image-grid">
                     <a href="https://horse-dev.testlinkdev.com/storage/uploads/services/1768928008_696fb3088c8ef.png" data-fancybox="group" data-caption="Horse">
                     <img src="https://horse-dev.testlinkdev.com/storage/uploads/services/1768928008_696fb3088c8ef.png" alt="img" class="">
                     </a>
                     <a href="https://horse-dev.testlinkdev.com/storage/uploads/services/1768928008_696fb308a7da4.png" data-fancybox="group" data-caption="Horse">
                     <img src="https://horse-dev.testlinkdev.com/storage/uploads/services/1768928008_696fb308a7da4.png" alt="img" class="">
                     </a>
                     <a href="https://horse-dev.testlinkdev.com/storage/uploads/services/1768928008_696fb308a9ccf.png" data-fancybox="group" data-caption="Horse">
                     <img src="https://horse-dev.testlinkdev.com/storage/uploads/services/1768928008_696fb308a9ccf.png" alt="img" class="">
                     </a>
                  </div>
               </div>
            </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Acupuncture</li>
                           <li>- Anhydrosis Treatment</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Blood Transfusion</li>
                           <li>- Cardiac Telemetry</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                     ...
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Respiratory Evaluations</li>
                           <li>- Telemetric Diagnostics</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                     ...
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Mare Management</li>
                           <li>- Auction Online</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Auction Live</li>
                           <li>- Horse Leasing Services</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Horse Local Transport</li>
                           <li>- Grooming Services</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- 4H Ffa Support</li>
                           <li>- Horsemanship Camps</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Junior Mounted Patrol</li>
                           <li>- Pony Parties</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Vocational Therapies</li>
                           <li>- Colt Starting</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Desensitization Training</li>
                           <li>- Foal Training</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Groundwork Horsemanship</li>
                           <li>- Horse Conditioning</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                     ...
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Jumping Training</li>
                           <li>- Liberty Training</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Mounted Archery</li>
                     ...
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Show Coaching</li>
                           <li>- Therapeutic Riding Instruction</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                     ...
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Full Care Boarding</li>
                           <li>- Layup Rehab Boarding</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Retirement Boarding</li>
                           <li>- Self Care Boarding</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Temporary Event Stabling</li>
                           <li>- Applied Equine Podiatry</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Hoof Casting</li>
                           <li>- Natural Hoof Care</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                     ...
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Equine Appraisals</li>
                           <li>- Equine Behavior Consulting</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Equine Branding Marketing</li>
                           <li>- Farm Ranch Bookkeeping</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Horse Ownership Consulting</li>
                     ...
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Bit Fitting</li>
                           <li>- Custom Leatherwork</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Mobile Feed Delivery</li>
                           <li>- Mobile Saddle Tack</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Mobile Veterinary Pharmacy</li>
                           <li>- Saddle Fitting Consulting</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Specialized Horse Feed</li>
                           <li>- Equine Photography Videography</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Horse Show Announcing</li>
                           <li>- Live Streaming</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Prize Procurement</li>
                           <li>- Show Steward</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <ul class="list-unstyled">
                           <li>- Stabling Grounds Crew</li>
                           <li>- Other Custom1</li>
                        </ul>
                     </div>
                     <div class="col-md-4">
         ...
         <div class="profile_tabs__one mb-4">
            <h2 class="about-title text-center">PHOTOS</h2>
            <div class="image-grid">
               <a href="https://horse-dev.testlinkdev.com/storage/uploads/services/1768928008_696fb3088c8ef.png" data-fancybox="group" data-caption="Horse">
               <img src="https://horse-dev.testlinkdev.com/storage/uploads/services/1768928008_696fb3088c8ef.png" alt="img" class="">
               </a>
         ...
         <div class="profile_tabs__one">
            <div class="side_box_one pt-4" bis_skin_checked="1">
               <div class="box_title" bis_skin_checked="1">
                  <h2>Pricing</h2>
                  <h2>
                  </h2>
               </div>
               <h5>$371</h5>
               <h6>$371 Per Session</h6>
               <h4>Payment Accepted</h4>
               <ul>
                  <li><span class="me-3"><img src="/assets/images/h_icon.png" alt="img" class="img-fluid"></span>Cash</li>
                  <li><span class="me-3"><img src="/assets/images/h_icon.png" alt="img" class="img-fluid"></span>Card</li>
               </ul>
            </div>
         </div>
      </div>
...
<script>
   ...
   addBtn.addEventListener('click', function(e) {
       ...
       newInputDiv.innerHTML = `
           <input class="form-control gen_input" type="text" name="demo_link[]" placeholder="e.g: https://www.youtube.com/watch?v=CjDbSzhmF2M" />
...
$(document).ready(function() {
    ...
    // Helper: YouTube URL to Embed Link
    ...
    $(previewBtn).on("click", function() {
        ...
        $overlay.find(".seller_profile_text_box h1").text(fullName || "Service Provider");
        const contactPs = $overlay.find(".seller_profile_text_box p");
        contactPs.eq(0).text(`Cell: ${phone || 'N/A'}`);
        contactPs.eq(1).text(email || 'N/A');

        // --- 2. Profile Image ---
        const profileFile = $('input[name="ser_profile"]')[0].files[0];
        if (profileFile) {
            const reader = new FileReader();
            reader.onload = (e) => { $overlay.find(".seller_profile_img img").attr("src", e.target.result); };
            reader.readAsDataURL(profileFile);
        }

        // --- 3. Experience & Languages ---
        const exp = $('input[name="experience"]').val();
        $overlay.find(".experience-value").text(`${exp || 0} Years`);
        const languages = $("#languagesInput").val();
        $overlay.find(".languages").text(languages ? languages.replace(/,/g, " | ") : "N/A");

        // --- 4. About Bio & Service Details (Summernote Version) ---
        // Summernote se direct HTML code uthane ke liye '.summernote('code')' use kiya hai
        const bio = $('textarea[name="per_bio"]').summernote('code');
        const details = $('textarea[name="service_desc"]').summernote('code');
        
        const aboutSections = $overlay.find(".about-text");
        
        // Pehle section mein Bio render karein
        // Summernote pehle se hi HTML tags (p, br) deta hai, isliye .replace ki zaroorat nahi
        if (aboutSections.length > 0) {
            const isBioEmpty = $(bio).text().trim() === "" && bio.indexOf('img') === -1;
            aboutSections.eq(0).html(!isBioEmpty ? bio : "No bio provided.");
        }
        
        // Doosre section mein Service Details render karein
        if (aboutSections.length > 1) {
            const isDetailsEmpty = $(details).text().trim() === "" && details.indexOf('img') === -1;
            aboutSections.eq(1).html(!isDetailsEmpty ? details : "No details provided.");
        }

        // --- 5. Services Offered Grid (Updated for Custom Services) ---
        const selectedServices = [];
        
        // 1. Pehle standard checkboxes ko check karein
        $('input[name="services_offered[]"]:checked').each(function() {
        ...
        // 2. Phir Custom Services (1 se 4) ko check karein
        for (let i = 1; i <= 4; i++) {
            const customCheckbox = document.getElementById(`other_custom${i}`);
            const customInput = document.querySelector(`input[name="custom_service_${i}"]`);
            
            // Agar checkbox checked hai AUR input mein kuch likha hua hai
            if (customCheckbox && customCheckbox.checked && customInput && customInput.value.trim() !== "") {
                selectedServices.push(customInput.value.trim());
            }
        }
        
        const servicesGrid = $overlay.find(".about-section .row").first();
        servicesGrid.empty();
        
        if (selectedServices.length > 0) {
            selectedServices.forEach(s => {
                servicesGrid.append(`<div class="col-md-4"><ul class="list-unstyled"><li>- ${s}</li></ul></div>`);
            });
        } else {
            servicesGrid.append(`<div class="col-12"><p>No services selected.</p></div>`);
        }

        // --- 6. Address & Areas ---
        const addr = $('input[name="Address"]').val();
        const city = $('input[name="city"]').val();
        const stateFull = $('select[name="state"]').val(); // Pura value uthaya e.g. "new york (NY)"
        
        // Yahan logic: Brackets () ke andar se abbreviation nikalne ke liye
        let stateAbbr = "";
        if (stateFull) {
            const match = stateFull.match(/\(([^)]+)\)/);
            stateAbbr = match ? match[1].toUpperCase() : stateFull; 
        }
        
        const zip = $('input[name="zip_code"]').val();
        const locTypes = $('input[name="service_location[]"]:checked').map(function(){ return $(this).val(); }).get().join(", ");
        const areas = $('input[name="features[]"]').map(function(){ return $(this).val().trim(); }).get().filter(v => v !== "");
        
        let addrHtml = `
            <h2 class="mt-2">BUSINESS PHYSICAL LOCATION:</h2>
            <div class="mb-3">
                <p class="mb-1">${addr || 'N/A'}</p>
                <p class="mb-0">${city || ''}${city?', ':''}${stateAbbr} ${zip || ''}</p> 
            </div>
            <h2 class="mt-4">SERVICE LOCATION:</h2><p>${locTypes || 'Not Specified'}</p>
            <h2 class="mt-4">SERVICE AREAS COVERED:</h2>
            <ul class="row list-unstyled">${areas.map(a => `<li class="col-6 mb-1">- ${a}</li>`).join('')}</ul>`;
        
        $overlay.find(".text_col").html(addrHtml);

        // --- 7. PRICING BOX (UPDATED) ---
        const priceRaw = $('input[name="pkg_price"]').val();
        const priceVal = priceRaw.startsWith('$') ? priceRaw : (priceRaw ? '$' + priceRaw : '$0');
        const isVarying = $('#vpps_p').is(':checked');
        const pTypes = $('input[name="pricing_type"]:checked').not('#vpps_p').map(function(){ return $(this).val(); }).get().join(", ");
        
        const sideBox = $overlay.find(".side_box_one");
        
        if(isVarying) {
            // Jab Varying Price per Service checked ho
            sideBox.find("h5").text("Varying Price per Service"); // Badi heading me $0
            sideBox.find("h6").text(""); // Choti heading me bhi $0
        } else {
            // Normal pricing logic
            sideBox.find("h5").text(priceVal);
            sideBox.find("h6").text(`${priceVal} ${pTypes ? pTypes : ''}`);
        }
        
        const payments = $(".dropdown-container[data-dropdown-name='payments'] .tag").map(function(){
            return $(this).text().replace('✕', '').trim();
        }).get();
        
        const payUl = sideBox.find("ul").empty();
        payments.forEach(p => {
            payUl.append(`<li><span class="me-3"><img src="/assets/images/h_icon.png" width="20"></span>${p}</li>`);
        });

        // --- 8. Gallery & Certifications ---
        const galleryFiles = document.getElementById("customImageInput").files;
        const photoGrid = $overlay.find('h2:contains("PHOTOS")').next(".image-grid").empty();
        Array.from(galleryFiles).forEach(file => {
            const reader = new FileReader();
            reader.onload = (e) => { photoGrid.append(`<a href="${e.target.result}" data-fancybox="preview-gallery"><img src="${e.target.result}" style="width:100%; height:220px; object-fit:cover;"></a>`); };
            reader.readAsDataURL(file);
        });

        const certFiles = $('input[name="certifications[]"]')[0].files;
        const certGrid = $overlay.find(".certifications-section .image-grid").empty();
        Array.from(certFiles).forEach(file => {
            if (file.type.match('image.*')) {
                const reader = new FileReader();
                reader.onload = (e) => { certGrid.append(`<a href="${e.target.result}" data-fancybox="preview-certs"><img src="${e.target.result}" style="width:100%; height:220px; object-fit:cover;"></a>`); };
                reader.readAsDataURL(file);
            } else {
                certGrid.append(`<div class="pdf-icon" style="width:100%; height:220px; object-fit:cover;">${file.name.split('.').pop().toUpperCase()}<div class="file-icon-text" bis_skin_checked="1">📄</div></div>`);
            }
        });

        // --- 9. VIDEOS (Hamesha pricing ke baad end mein) ---
        const videoLinks = $('input[name="demo_link[]"]').map(function(){ return $(this).val().trim(); }).get().filter(v => v !== "");
        // Pricing wala box jis tab mein hai uske baad agar koi tab nahi to naya banayein ya existing use karein
        let videoContainer = $overlay.find(".profile_tabs__one").last();
        
        // Agar aakhri container pricing wala hi hai, to usme append nahi karna, alag dikhana hai
        if (videoLinks.length > 0) {
            // Check if last container is actually for videos
            if (videoContainer.find('.side_box_one').length > 0) {
                // Agar pricing wala hai to uske bahar append karein
                if($overlay.find("#preview-video-container").length === 0) {
                    videoContainer.after('<div id="preview-video-container" class="profile_tabs__one mt-4"></div>');
                }
                videoContainer = $overlay.find("#preview-video-container");
            }
            
            videoContainer.show().empty(); 
            videoContainer.html(`<h2 class="about-title text-center">VIDEO INTRODUCTIONS</h2>`);
            videoLinks.forEach(link => {
                const embed = getYoutubeEmbedUrl(link);
                if (embed) {
                    videoContainer.append(`<iframe src="${embed}" style="width: 100%; height: 450px; margin-top: 20px; border-radius: 12px; border:2px solid #1d2139;" frameborder="0" allowfullscreen></iframe>`);
                }
            });
        } else {
            $overlay.find("#preview-video-container").hide();
            if (videoContainer.find('.about-title:contains("VIDEO")').length > 0) videoContainer.hide();
        }

        // --- 10. Social Links ---
        const socialIcons = $overlay.find(".social_icons a");
        socialIcons.eq(0).attr("href", $('input[name="facebook"]').val() ? "http://" + $('input[name="facebook"]').val() : "#!");
        socialIcons.eq(1).attr("href", $('input[name="youtube"]').val() ? "http://" + $('input[name="youtube"]').val() : "#!");
        socialIcons.eq(2).attr("href", $('input[name="tiktok"]').val() ? "http://" + $('input[name="tiktok"]').val() : "#!");
        socialIcons.eq(3).attr("href", $('input[name="insta"]').val() ? "http://" + $('input[name="insta"]').val() : "#!");
        socialIcons.eq(4).attr("href", $('input[name="website_url"]').val() ? "http://" + $('input[name="website_url"]').val() : "#!");
    ...
    $overlay.on("click", function(e) {
        if ($(e.target).hasClass("fsm-overlay") || $(e.target).hasClass("fsm-close")) {
