			...
			<div class="loginReg">
				...
				<form method="POST" action="{{ route('login') }}" class="my-4">
					...
					<div class="filed_wrap">
						...
						<input id="email" placeholder="Email" type="email" class="form-control @error('email') is-invalid @enderror input" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
					</div>
					<div class="filed_wrap">
						<!-- <span class="lable">Password</span> -->
						<div class="pass_field_wrap">
							<input id="password" placeholder="Password" type="password" class="form-control @error('password') is-invalid @enderror passwordInput input" name="password" required autocomplete="current-password" pattern=".{8,}">
